...
| Seed data | The first-launch state of MF-SDD-001, 3.5.5: **105 questions, 21 tags and 373 assignments** — the 25 questions, 9 tags and 53 assignments of the SQL fixture, plus the 80 questions, 12 tags and 320 assignments of the carried question sets. This is the starting state of every manual procedure unless the procedure states otherwise. A change to the SQL fixture or to `app/src/main/assets/question-sets/` changes this baseline, and the procedures that quote a count must be re-anchored with it. |
...
|---|---|---|---|
| Are the requirements verified? | Requirement verification coverage: requirements with a passing record ÷ 121 | Per release candidate | Must be 100 % before a release baseline. |
